               ...
               <video className="background-video" loop muted autoPlay>
                ...
                <div className ="border">
                 ...
                 <h2>
                  ...
                  <div>
                  <Link to="/">
                          <button onClick = {this.props.userRecommendationsFb} className="facebook"><img alt="fb" class="btnIcon" src={require("../../img/fb.png")}/><span>Login with Facebook</span></button>
                  </Link>
                  </div>
                </form>
              </div>
